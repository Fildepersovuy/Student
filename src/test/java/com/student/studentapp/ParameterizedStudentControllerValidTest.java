...
public class ParameterizedStudentControllerValidTest {
    ...
    static Stream<StudentDto> getParams() throws ParseException {
        ...
        String student = list.stream()
                .map(studentDto1 ->
                {
                    try {
                        return new StudentDto(  new SimpleDateFormat("yyyy-MM-dd").parse("1991-03-02");
